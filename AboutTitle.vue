<template>
  <div class="about-company-info-text other-text-style">
    <p>Создание коттеджных поселков – основное направление нашей работы.</p>
    <p> Мы:облагораживаем и обустраиваем территорию;
      проводим коммуникации и создаем инфраструктуру для жизни;
      обеспечиваем сохранность благоустройства и атмосферы в каждом поселке.</p>
    <p> Мы работаем для того, чтобы вам не пришлось ни о чем думать. Проводим оптоволокно,
